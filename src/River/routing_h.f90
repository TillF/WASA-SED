...
!! sediment entering reach/subbasin for each particle size class k (tons/timestep)
real, allocatable :: sediment_in(:,:)
!! sediment leaving reach/subbasin for each particle size class k (tons/timestep)
